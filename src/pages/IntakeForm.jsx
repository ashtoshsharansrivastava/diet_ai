...
const IntakeForm = () => {
  ...
  return (
    <Layout> {/* 👈 Wrapped everything in Layout */}
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="animate-fade-in-down">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input type="number" value={userProfile.age} onChange={e => updateProfile('age', e.target.value)} className="w-full p-3 border rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none" placeholder="Years" />
                  </div>
                  <div className="col-span-2 sm:col-span-1">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full p-3 pl-10 border rounded-xl bg-white appearance-none focus:ring-2 focus:ring-emerald-500 outline-none"
                      >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div 
                      ...
                      className={`p-4 rounded-xl border-2 cursor-pointer flex items-center justify-between transition-all ${userProfile.conditions.includes(condition.id) ? 'border-emerald-500 bg-emerald-50' : 'border-slate-100 hover:border-slate-300'}`}
                    >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {['veg', 'eggitarian', 'non-veg', 'vegan'].map((type) => (
                      <button
                        ...
                        className={`py-3 px-2 rounded-lg text-sm font-bold capitalize transition-colors ${userProfile.dietType === type ? 'bg-emerald-500 text-white shadow-lg' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                      >
                        {type}
                      </button>
                    ))}
          ...
          <div className="bg-slate-50 p-6 flex justify-between border-t border-slate-200">
            ...
            {step < 3 ? (
               ...
               className="flex items-center bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3 rounded-lg font-bold shadow-lg transition-all"
             >
